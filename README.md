...
[Current Version: 7.7](#-preview) <img src="date3.svg" style="height: 1em; vertical-align: -3em;">  
...
### 🌐 Preview
- All-in-One (Portable+Standard editions) ZIP package (Google Drive, ≤ 110 KB) https://bit.ly/4xgBhLV
- Portable: delete AudioFakeDetector_v7.7.ps1 in AudioFakeDetector_v7.7_All-In-One.zip
- Standard: delete AudioFakeDetector_v7.7_Portable.ps1 in AudioFakeDetector_v7.7_All-In-One.zip 
