...
* Windows 10/11 (32-bit or 64-bit) / v8.x: Windows 10/11 64-bit + .NET Desktop Runtime 8
* PowerShell 5+
...
* AudioFakeDetector8.7z (Full offline, .NET Desktop Runtime 8 web download offered)  
